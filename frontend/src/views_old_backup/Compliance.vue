...
const complianceStats = [
  { label: '拦截违规内容', value: '2,847', unit: '次', icon: BanIcon },
  { label: 'AI幻觉修正率', value: '94.2', unit: '%', icon: CpuIcon },
  { label: '数据泄露事件', value: '0', unit: '起', icon: LockIcon },
  { label: '规则校验通过', value: '99.8', unit: '%', icon: VerifiedIcon },
];
...
<template>
  <div class="min-h-screen bg-slate-50">
    ...
    <main class="max-w-7xl mx-auto px-4 py-8">
      ...
      <div class="bg-white rounded-xl border border-slate-200 p-6 mb-8">
        <h2 class="text-lg font-semibold text-slate-900 mb-6">合规价值量化</h2>
